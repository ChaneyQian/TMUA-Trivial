...
// 公式渲染的实现体。外面那个 MathText.tsx 是它的 next/dynamic 门面——
// 首屏（卡组）一道题都不渲染，katex 的 JS 与 CSS 没有理由跟着冷启动一起下。
//
// katex 的样式表就跟在这里而不是 layout.tsx：CSS 要和用到它的那个 chunk
// 同生共死，挂在根布局上等于让每个只看封面的人都下一份。
