...
subtopics: [Coordinate Geometry, Differentiation Application]
tags: [Minimum-Distance, Tangent-Parallel-to-Line, Perpendicular-Distance]
status: 已合审
---
...
The gradient of the line is 2, and the curve has gradient $\begin{array} { r } { \frac { \mathrm { d } y } { \mathrm { d } x } = 2 x , \mathrm{so} \ \frac { \mathrm { d } y } { \mathrm { d } x } = 2 } \end{array}$ when $x = 1$ , so (1, 5) is the closest point on the curve to the line.
